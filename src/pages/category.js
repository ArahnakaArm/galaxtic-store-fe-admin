              ...
              <table className="border-collapse table-auto w-full text-sm">
                <thead>
                  <tr>
                    ...
                    <th className="table-header-name border-b dark:border-slate-600 font-medium p-4 pt-0 pb-3 text-slate-400 dark:text-slate-200 text-center">Action</th>
                  </tr>
                </thead>
                  ...
                  {!isLoading &&
                    ...
                    categories.map((cate) => (
                      <tr key={cate.main_category_id}>
                        <td className="text-start border-b border-slate-100 dark:border-slate-700 p-4 pl-8 text-slate-500 dark:text-slate-400">{cate.main_category_name}</td>
                        <td className="text-start border-b border-slate-100 dark:border-slate-700 p-4 pr-8 text-slate-500 dark:text-slate-400">{cate.updated_at}</td>
                        <td className="flex justify-center items-center h-full p-4">
                          <div className="flex items-center justify-center h-full">
                            <div onClick={() => toggleSwitch(cate.main_category_id)} className="relative">
